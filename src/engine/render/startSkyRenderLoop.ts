...
export function startSkyRenderLoop(options: {
  ...
  const render = () => {
    ...
    if (sunAltitude !== lastSunAltitude || layersChanged) {
    ...
    if (frameStats.filled === frameStats.capacity) {
